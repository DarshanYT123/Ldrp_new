...
import FatherSignature from "./FatherSignature";
  ...
  return (
     ...
     <div className="">
      {/* <div classname=" top-8 right-0  px-10  py-5 overflow-y-auto h-[5rem]  bg-white"> */}
        ...
        {/* <div className="sticky top-5 "> */}
          <div className="flex justify-between flex-row py-5 items-center ">
 	 ...
 	 <label className="flex flex-row justify-center items-center">
 	 	 <input type="radio"      name="selectCounselling"
                value="Routine"
   ...
   <div class="form-box1 ">
 	 <label className="flex flex-row justify-center items-center">
          ...
          <div class="mb-6">
            <label
              for="IdentifyReason "
              className="  block py-2 text-left  text-[16px]  font-inter font-semibold text-[#1E1E1E] leading-[24px]"
            >
              2. Identify Reason :
            </label>
 	 ...
 	 <label className="flex flex-row justify-center items-center">
 	 	 <input type="radio"      name="selectCounselling"
                ...
                checked={selectCounselling === '  Habitually Late'}
                onChange={ handleselectCounsellingchange }
                tabIndex="3"/>
 	 	 <div class="circle"></div>
 	 	 <span 
                className="font-Poppins font-medium text-[#2C2C2E] text-[14px] leading-[21px]"
                >  Habitually Late</span>
 	 </label>
   ...
   <div class="form-box ">
 	 <label className="flex flex-row justify-center items-center">
 	 	 <input type="radio"      name="selectCounselling"
                value="Punctual"
                checked={selectCounselling === 'Punctual'}
                onChange={ handleselectCounsellingchange }
                tabIndex="3"/>
 	 	 <div class="circle"></div>
 	 	 <span 
          ...
          <div class="mb-6">
            <label
              for="Other "
              className=" flex py-2 text-left  text-[14px]  font-inter font-medium text-[#1E1E1E] leading-[24px]"
            >
             Other:
            </label>
          ...
          <div className="flex  justify-between items-center flex-row py-5 ml-3">
            <div className="flex">
              <label
                for="studentname"
