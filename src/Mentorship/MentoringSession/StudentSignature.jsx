...
<div className="">
<h2 className="py-2 text-[color:var(--black,#101010)] text-[16px] font-Poppins not-italic font-semibold leading-[normal] tracking-[0.32px] capitalize">Student Signature</h2>
</div>
    <span
