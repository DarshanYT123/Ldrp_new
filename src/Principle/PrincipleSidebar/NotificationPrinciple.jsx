...
const sendEmail = (e) => {
  ...
  emailjs.sendForm('service_jgqlbed', 'template_1c899wl', form.current, 'wdbUMZj1wxtv4qcy3')
    .then((result) => {
  ...
  return (
    ...
    <div className="relative w-full ">
      <input type="text" className="w-[100%]   py-2 border-[1px] px-4 border-[color:var(--Desable-Grey,#BDBDBD)] rounded-[5px] border-solid" placeholder="Search Conversion" value={filter} onChange={searchText.bind(this)} />
  ...
  <h1 className="text-[rgba(16,16,16,0.55)]  text-[10px] font-inter not-italic font-medium leading-[normal] tracking-[0.2px]">{item.text4}</h1>
   ...
   <button className="px-8 py-2 bg-[#159BD6] shadow-[0px_4px_8px_0px_rgba(184,182,182,0.25)] rounded-[5px]   text-[color:var(--03,#FFF)] text-[16px] font-inter not-italic font-bold leading-[normal] tracking-[0.32px] capitalize ">Clear</button>
    <button className="px-8 py-2 bg-[#16376E] shadow-[0px_4px_8px_0px_rgba(184,182,182,0.25)] rounded-[5px]     text-[color:var(--03,#FFF)] text-[16px] font-inter not-italic font-bold leading-[normal] tracking-[0.32px] capitalize">Compose</button>
      ...
      <div className="bg-white h-full w-[50%] p-5 rounded-lg ">
   ...
   <div className="flex flex-col gap-y-4">
    ...
    <div className="flex flex-row gap-x-6 items-center">
      ...
      <input type="text" name="from_name" className="w-full py-3  border-[color:var(--Desable-Grey,#BDBDBD)]  rounded-[5px] border-[0.3px] border-solid"></input>
    </div>
    <div className="flex flex-row gap-x-2 items-center">
      ...
      <input type="text" name="from_email" className="w-full py-3  border-[color:var(--Desable-Grey,#BDBDBD)]  rounded-[5px] border-[0.3px] border-solid"></input>
    </div>
    <textarea typeof="text" name="message" placeholder="Write message here" className=" p-2 w-full  text-[color:var(--Desable-Grey,#BDBDBD)] text-[14px] font-inter not-italic font-medium leading-[normal] tracking-[0.28px] capitalize h-[25rem] resize-none rounded-[5px] bg-[#F5F5F5]" ></textarea>
    {/* <input
            name="image"
            type="file"
            onClick={addFile}
   ...
   <button className="px-8 py-2 bg-[#159BD6] shadow-[0px_4px_8px_0px_rgba(184,182,182,0.25)] rounded-[5px]   text-[color:var(--03,#FFF)] text-[16px] font-inter not-italic font-bold leading-[normal] tracking-[0.32px] capitalize ">Undo</button>
    <button type="submit" value="Send"  className="px-8 py-2 bg-[#16376E] shadow-[0px_4px_8px_0px_rgba(184,182,182,0.25)] rounded-[5px]     text-[color:var(--03,#FFF)] text-[16px] font-inter not-italic font-bold leading-[normal] tracking-[0.32px] capitalize">Send</button>
   </div>
   </form>
    </div>
      </div>
...
export default NotificationPrinciple