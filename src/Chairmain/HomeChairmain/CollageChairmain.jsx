...
{/* <div className="bg-white w-full h-[35px] border-gray-300 border-[2px] py-1 gap-x-4 flex flex-row justify-center items-center ">
   
    <div className="hover:bg-slate-200  hover:rounded-[5px] "><MdOutlineAttachFile /></div>
<div className="hover:bg-slate-200  hover:rounded-[5px] "><MdOutlineLink /></div>
...
export default CollageChairmain;
