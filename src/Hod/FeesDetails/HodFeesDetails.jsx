...
const handlebutton = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-row absolute pt-1 top-20 gap-x-1 justify-start items-center">
          ...
          <div className="flex flex-row gap-x-[22rem] py-5  items-center justify-center">
            <div>
              <span
                ...
                type="button"
                class="text-white text-[16.5px] font-inter   bg-[#159BD6] rounded-[5px]  font-bold px-12 py-2.5 mr-2 mb-2 leading-[19.36px] tracking-[2%] capitalize"
              >
                <input
                    type="file"
                    id="imageUpload"
