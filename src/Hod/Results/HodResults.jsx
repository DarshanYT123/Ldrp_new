...
const HodResults = ({handleNextStep}) => {
  ...
  const Data = [
    {
        ...
        spi:"7.5",
        Monthly:"-",
        path:"/resultshod/resultshoddetails",
    },
    {
        Eno:"21BECE30002",
        Fname:"Raj Mehta",
...
<h1 className='text-[color:var(--black,#101010)] text-[14px] font-inter not-italic font-semibold leading-[normal] tracking-[0.28px] capitalize'>Results</h1>
<FaArrowRight />
