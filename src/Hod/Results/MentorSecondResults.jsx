...
const MentorSecondResults = () => {
  ...
  return (
    <>
     <div className="top-8 right-0 px-4 py-5 bg-white">
        

        <form>
          <div className="flex space-x-[4rem] py-5  items-center justify-center">
          <span
          onClick={ handlebutton}
          htmlFor="filePicker" className="text-[color:var(--03,#FFF)] text-[16px] font-inter not-italic font-bold leading-[normal] tracking-[0.32px] capitalize px-10 shadow-[0px_4px_8px_0px_rgba(184,182,182,0.25)] rounded-[5px] py-2 bg-[#159BD6]">
...
{selectedImage && (
            <div>
               <span
                 onClick={handlebutton}
               className="text-[color:var(--03,#FFF)] text-[16px] font-inter not-italic font-bold leading-[normal] tracking-[0.32px] capitalize px-10 shadow-[0px_4px_8px_0px_rgba(184,182,182,0.25)] rounded-[5px] py-2 bg-[#159BD6]">
          ...
          <div className="flex space-x-2  items-center justify-center">
            ...
            <div>
              <div className=" ">
                <div className="py-2" >
                  <h2 className="text-[color:var(--02,#16376E)] text-center text-[18px] font-inter not-italic font-bold leading-[21.78px] tracking-[2px]">
