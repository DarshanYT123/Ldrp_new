...
const AttendanceTableHodDetails = ({ handleNextStep }) => {
  ...
  const Data = [
    {
      ...
      AoA: "75%",
      Monthly: "100%",
      path: "/attendancehod/attendancehoddetails",
    },
    {
      Eno: "21BECE30002",
      Fname: "Parth Patel",
      AoA: "75%",
      Monthly: "100%",
      path: "/attendancementor/mentorattendance",
    },
    {
      Eno: "21BECE30003",
      Fname: "Ramesh Rana",
...
<h1 className='text-[color:var(--black,#101010)] text-[14px] font-inter not-italic font-semibold leading-[normal] tracking-[0.28px] capitalize'>Attendance</h1>
<FaArrowRight />
...
export default AttendanceTableHodDetails;
